...
struct StackCardView: View {
    ...
    var body: some View {
        ...
        .offset(x: offset)
        .rotationEffect(.init(degrees: getRotation(angle: 5)))
        ...
        .onChange(of: isDragging, perform: { value in
            if value == false {
                withAnimation{
                    offset = .zero
                }
        ...
        // Reciving Notifications Posted...
        .onReceive(NotificationCenter.default.publisher(for: Notification.Name("ACTIONFROMBUTTON"), object: nil), perform: {data in
